...
public class AsignarTransaccion implements Serializable {
    ...
    public Boolean getAsitraEstado() {
        return asitraEstado;
    }

    public void setAsitraEstado(Boolean asitraEstado) {
    ...
    public String toString() {
        return "ec.edu.espe.arqui.modelos.AsignarTransaccion[ asitraId=" + asitraId + " ]";
    }
