...
public class InstitucionFinanciera implements Serializable {
    ...
    public Boolean getInsfinEstado() {
        return insfinEstado;
    }

    public void setInsfinEstado(Boolean insfinEstado) {
    ...
    public String toString() {
        return "ec.edu.espe.arqui.modelos.InstitucionFinanciera[ insfinIdentificacion=" + insfinIdentificacion + " ]";
    }
